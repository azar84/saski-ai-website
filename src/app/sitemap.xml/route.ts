...
async function transformSitemapIndexToHTML(): Promise<string> {
  ...
  const [pagesCount, faqCategoriesCount, faqsCount] = await Promise.all([
    prisma.page.count(),
...
<body>
  ...
  <div class="description">
    ...
    <p>This index references <strong>3 individual sitemaps</strong> containing our content.</p>
  </div>
...
async function generateSitemapIndex(): Promise<string> {
  ...
  const [pages, faqCategories, faqs] = await Promise.all([
