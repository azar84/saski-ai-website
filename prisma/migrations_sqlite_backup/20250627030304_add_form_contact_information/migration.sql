...
INSERT INTO "new_forms" ("captchaDifficulty", "captchaType", "createdAt", "ctaBackgroundColor", "ctaBorderColor", "ctaHoverBackgroundColor", "ctaHoverTextColor", "ctaIcon", "ctaLoadingText", "ctaSize", "ctaStyle", "ctaText", "ctaTextColor", "ctaWidth", "emailNotification", "emailRecipients", "enableCaptcha", "errorMessage", "id", "isActive", "name", "redirectUrl", "subheading", "successMessage", "title", "updatedAt", "webhookUrl") SELECT "captchaDifficulty", "captchaType", "createdAt", "ctaBackgroundColor", "ctaBorderColor", "ctaHoverBackgroundColor", "ctaHoverTextColor", "ctaIcon", "ctaLoadingText", "ctaSize", "ctaStyle", "ctaText", "ctaTextColor", "ctaWidth", "emailNotification", "emailRecipients", "enableCaptcha", "errorMessage", "id", "isActive", "name", "redirectUrl", "subheading", "successMessage", "title", "updatedAt", "webhookUrl" FROM "forms";
DROP TABLE "forms";
