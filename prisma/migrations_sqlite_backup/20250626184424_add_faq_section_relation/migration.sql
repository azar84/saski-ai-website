...
INSERT INTO "new_page_sections" ("contactSectionId", "content", "createdAt", "faqCategoryId", "featureGroupId", "heroSectionId", "id", "isVisible", "mediaSectionId", "pageId", "pricingSectionId", "sectionType", "sortOrder", "subtitle", "title", "updatedAt") SELECT "contactSectionId", "content", "createdAt", "faqCategoryId", "featureGroupId", "heroSectionId", "id", "isVisible", "mediaSectionId", "pageId", "pricingSectionId", "sectionType", "sortOrder", "subtitle", "title", "updatedAt" FROM "page_sections";
