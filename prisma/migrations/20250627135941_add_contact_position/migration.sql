...
INSERT INTO "new_forms" ("captchaDifficulty", "captchaType", "contactAddress", "contactEmail", "contactPhone", "createdAt", "ctaBackgroundColor", "ctaBorderColor", "ctaHoverBackgroundColor", "ctaHoverTextColor", "ctaIcon", "ctaLoadingText", "ctaPosition", "ctaSize", "ctaStyle", "ctaText", "ctaTextColor", "ctaWidth", "emailNotification", "emailRecipients", "enableCaptcha", "errorMessage", "fieldBackgroundColor", "fieldBorderColor", "fieldTextColor", "formBackgroundColor", "formBorderColor", "formTextColor", "id", "isActive", "name", "redirectUrl", "sectionBackgroundColor", "showContactInfo", "socialFacebook", "socialInstagram", "socialLinkedin", "socialTwitter", "socialYoutube", "subheading", "successMessage", "title", "updatedAt", "webhookUrl") SELECT "captchaDifficulty", "captchaType", "contactAddress", "contactEmail", "contactPhone", "createdAt", "ctaBackgroundColor", "ctaBorderColor", "ctaHoverBackgroundColor", "ctaHoverTextColor", "ctaIcon", "ctaLoadingText", "ctaPosition", "ctaSize", "ctaStyle", "ctaText", "ctaTextColor", "ctaWidth", "emailNotification", "emailRecipients", "enableCaptcha", "errorMessage", "fieldBackgroundColor", "fieldBorderColor", "fieldTextColor", "formBackgroundColor", "formBorderColor", "formTextColor", "id", "isActive", "name", "redirectUrl", "sectionBackgroundColor", "showContactInfo", "socialFacebook", "socialInstagram", "socialLinkedin", "socialTwitter", "socialYoutube", "subheading", "successMessage", "title", "updatedAt", "webhookUrl" FROM "forms";
DROP TABLE "forms";
